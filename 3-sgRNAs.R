...
offTargetAnalysis(inputFilePath = paste(inputDir, inputFasta, sep="/"),    format = "fasta",     header = FALSE, 
                  gRNAoutputName = inputFasta ,       findgRNAs = TRUE,  exportAllgRNAs = "all",  
                  ...
                  BSgenomeName=BSgenome.Mmusculus.UCSC.mm9,   chromToSearch = "", 
                  ...
                  max.mismatch = 0, PAM.pattern = "NGG$", allowed.mismatch.PAM = 1, 
                  gRNA.pattern = "^G(?:(?!T{5,}).)+$",   min.score = 0.5,   topN = 20, 
