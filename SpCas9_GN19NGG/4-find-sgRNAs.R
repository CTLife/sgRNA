...
offTargetAnalysis(      inputFilePath=paste(inputDir, inputFasta, sep="/"),   format="fasta",   header=FALSE,   gRNAoutputName=inputFasta,   findgRNAs=TRUE,
			...
			PAM.size=3,    gRNA.size=20,  PAM="NGG",   BSgenomeName=BSgenome.Mmusculus.UCSC.mm9,    chromToSearch="",
			...
			max.mismatch=3,   PAM.pattern="NGG$",      allowed.mismatch.PAM=1,   gRNA.pattern="",  
